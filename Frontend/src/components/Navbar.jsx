        ...
        <nav className='flex flex-wrap items-center gap-4'>
            ...
            {user && (
                <Link to={"/cart"} className='relative group text-gray-300 hover:text-emerald-400 transition duration-300 ease-in-out'>
                    ...
                    <span className='bg-emerald-500 text-white rounded-full px-2 py-0.5 text-xs absolute -top-2 -left-2 group-hover:bg-emerald-400 transition duration-300 ease-in-out'>3</span>
                </Link>
            )}
            {isAdmin && (
                <Link to={"/dashboard"} className='flex items-center px-3 py-1 rounded-md font-medium text-gray-300 bg-emerald-700 hover:bg-emerald-600 transition duration-300 ease-in-out'>
